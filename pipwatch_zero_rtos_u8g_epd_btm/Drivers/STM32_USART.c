...
GPIO_InitTypeDef GPIO_InitStructure;
	...
	if( ulPort < serNUM_COM_PORTS )
	{
		...
		if( ulPort == 0 )
		{
			...
			/* Configure USART1 Rx (PA10) and CTS (PA11) as input floating */
			GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10 | GPIO_Pin_11;
			GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
			GPIO_Init( GPIOA, &GPIO_InitStructure );
			
			/* Configure USART1 Tx (PA9) and RTS (PA12) as alternate function push-pull */
		...
		else if( ulPort == 1 )
		{
			...
			/* Configure USART2 Rx (PA3), CTS (PA0) as input floating */
			GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3 | GPIO_Pin_0;
			GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
			GPIO_Init( GPIOA, &GPIO_InitStructure );
			
			/* Configure USART2 Tx (PA2), RTS (PA1) as alternate function push-pull */
...
signed long xSerialPutChar( long lPort, char cOutChar, TickType_t xBlockTime )
{
    long lReturn;
